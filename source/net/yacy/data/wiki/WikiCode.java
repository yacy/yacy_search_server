...
public class WikiCode extends AbstractWikiParser implements WikiParser {
    ...
    private static final String WIKI_YOUTUBE = "Youtube:";
    ...
    private static final int LEN_WIKI_YOUTUBE = WIKI_YOUTUBE.length();
    ...
    private static String processLinksAndImages(final String hostport, String line) {
        ...
        while ((positionOfOpeningTag = line.indexOf(WIKI_OPEN_LINK)) >= 0) {
            ...
            // this is the part of the code that's responsible for Youtube video links supporting only the video ID as parameter
            else if (kl.startsWith(WIKI_YOUTUBE)) {
            	kl = kl.substring(LEN_WIKI_YOUTUBE);

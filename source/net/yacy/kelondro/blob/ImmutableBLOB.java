...
public interface ImmutableBLOB {
 ...
 /**
  * Close the BLOB table and optionally publish its index fingerprint.
  *
  * @throws UncheckedIOException when closing storage or publishing the complete
  *         fingerprint pair fails; the signature remains unchecked for compatibility
  *         with the existing BLOB lifecycle
  */

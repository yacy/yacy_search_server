...
public final class RemoteProxyConfig {
     ...
     */
    private static RemoteProxyConfig remoteProxyConfig = null;
     ...
     */
    public static synchronized RemoteProxyConfig getRemoteProxyConfig() {
     ...
     * @return
     */
    public static RemoteProxyConfig createRemoteProxyConfig(
            final String proxyHostName,
            final int proxyHostPort
    ) {
        final RemoteProxyConfig newConfig = new RemoteProxyConfig();
     ...
     * @return
     */
    public static void init(final Switchboard sb) {
        ...
        // create new config
        final RemoteProxyConfig newConfig = createRemoteProxyConfig(proxyHostName, proxyHostPort);
     ...
     */
    public static RemoteProxyConfig getProxyConfigForHost(final String server) {
        final RemoteProxyConfig proxyConfig = getRemoteProxyConfig();
     ...
     */
    public static RemoteProxyConfig getProxyConfigForURI(final String address) {
        // host goes to port

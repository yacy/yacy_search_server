...
#JAVA_ARGS="-XX:+AlwaysPreTouch -XX:+UseG1GC $JAVA_ARGS";
JAVA_ARGS="-XX:+UseStringDeduplication -XX:+ParallelRefProcEnabled $JAVA_ARGS";
JAVA_ARGS="-XX:+AggressiveOpts $JAVA_ARGS";

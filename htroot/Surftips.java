...
public class Surftips {
    ...
    public static serverObjects respond(final httpRequestHeader header, final serverObjects post, final serverSwitch<?> env) {
        ...
        if ((publicPage) || (authorizedAccess)) {
            ...
            final kelondroRow rowdef = new kelondroRow("String url-255, String title-120, String description-120, String refid-" + (kelondroDate.PATTERN_SHORT_SECOND.length() + 12), kelondroNaturalOrder.naturalOrder, 0);
    ...
    private static void accumulateSurftips(
            ...
            final HashMap<String, Entry> surftips, final kelondroMScoreCluster<String> ranking, final kelondroRow rowdef,

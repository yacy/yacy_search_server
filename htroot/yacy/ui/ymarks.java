...
public class ymarks {
    ...
    private static void printTagList(final plasmaSwitchboard sb, final String id, final String tagName, final int comp, final int max, final boolean opt){    	
    	int count=0;
        bookmarksDB.Tag tag;
    ...
    private static int recurseFolders(final plasmaSwitchboard sb, final Iterator<String> it, String root, int count, final boolean next, final String prev){
    	String fn="";    	
    	bookmarksDB.Bookmark bookmark;
    ...
    private static void publishNews(final plasmaSwitchboard sb, final String url, final String title, final String description, final String tagsString) {
